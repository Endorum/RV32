...
void RV32::MEM() {
    ...
    if(instr_cache.opc == LOAD){ // load
        switch(instr_cache.funct3){
            ...
            case 0x0: mem_result = static_cast<i8>(load(alu_result,  BYTE)); break;
            case 0x1: mem_result = static_cast<i16>(load(alu_result, HALF)); break;
            case 0x2: mem_result = static_cast<i32>(load(alu_result, WORD)); break;
            case 0x4: mem_result = static_cast<u8>(load(alu_result,  BYTE)); break;
            case 0x5: mem_result = static_cast<u16>(load(alu_result, HALF)); break;
        ...
        switch(instr_cache.funct3){
            ...
            case 0x0: instr_cache.mnemonic = "sb"; store(alu_result, BYTE,  static_cast<u8>(src2_value)); break;
            case 0x1: instr_cache.mnemonic = "sh"; store(alu_result, HALF, static_cast<u16>(src2_value)); break;
            case 0x2: instr_cache.mnemonic = "sw"; store(alu_result, WORD, static_cast<u32>(src2_value)); break;
